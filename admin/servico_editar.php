        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-suitcase"></i>  <span>Serviço</span></h2>
                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info"><p><strong>Editar Serviço</strong></p> <i class="fa fa-exclamation-triangle"></i> Descrição no máximo 150 caracteres </div>
                                </div>
                                        ...
                                        <form method="post" action="servico_fn.php?acao=atualizar">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  class="chosen-select mb-15" data-placeholder="Selecione um Ícone" id="servico_icon" name="servico_icon">
                                                    ...
                                                    <?php foreach ($icones->db->data as $icon) : ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control rounded" id="servico_descricao" name="servico_descricao" style="max-height:50px;"><?= stripslashes($servico->servico_descricao) ?></textarea>
