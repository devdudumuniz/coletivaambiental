                            ...
                            <?php foreach ($clientes->db->data as $listar): ?>
                                <li class="col-md-3">
                                    <div class="gallery-item rounded shadow">
                                        ...
                                        <a href="javascript:void(0);" class="gallery-img"><img src="thumb.php?w=400&h=300&zc=1&src=../images/team/<?= $listar->cliente_imagem ?>" class="img-responsive full-width" alt="..." /></a>
                                        <br />
                                        ...
                                        <div class="gallery-details">
                                            <div class="text-center">
                                                <a class="btn btn-circle btn-info atualizar"  href="./cliente_editar.php/<?= $listar->cliente_id ?>/">
