        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                <div class="header-content">
                    <h2><i class="fa fa-suitcase"></i> <span>Serviços Cadastrados</span></h2>
                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><a class="btn btn-primary" href="servico/novo/"  style="color:#fff"><i class="fa fa-plus-circle" ></i> Novo Servico</a></h3>
                                    </div>
                                        ...
                                        <tbody>
                                            <?php if (isset($servico->db->data[0])): ?>
                                                <?php foreach ($servico->db->data as $service): ?>
                                                    <tr>
                                                        <td><i class="<?= $service->servico_icon ?>"></i></td>
                                                        <td><?= stripslashes($service->servico_nome) ?></td>
                                                        <td><?= stripslashes($service->servico_descricao) ?></td>
                                                        <td style="width: 110px;">
                                                            <a class="btn btn-circle btn-info atualizar" href="servico/editar/<?= $service->servico_id ?>/" >
