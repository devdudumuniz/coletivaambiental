...
<html lang="pt-br">
    ...
    <head>
        ...
        <link type="text/css" id="colors" rel="stylesheet" href="css/<?= $topo->modulo1_color ?>.css">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <?php if (isset($_POST['busca'])) : ?>
                                    <?php $pagina->getSearch(); ?>
                                    <?php if ($pagina->db->data[0]): ?>
                                            ...
                                            <article class="post clearfix">
                                                ...
                                                <div class="row">
                                                    <div class="postMeta col-sm-1 col-xs-2">
                                                        <i class="iconRounded <?= stripslashes($blog->modulo10_icon) ?>"></i>
                                                    </div>
                                                    <section class="col-sm-11 col-xs-10">
                                                        <h2><a href="post/"><?= stripslashes($pos->pagina_nome) ?></a></h2>
                                                        <p>
                                                        ...
                                                        <ul class="entry-meta">
                                                            ...
                                                            <li class="entry-category"><a href="javascript:void(0);"><i class="icon-th-list"></i>&nbsp;<?= $pos->area_nome ?></a></li>
                                                            <li class="entry-author"><a href="javascript:void(0);"><i class="icon-male"></i>&nbsp;<?= $pos->pagina_autor ?></a></li>
